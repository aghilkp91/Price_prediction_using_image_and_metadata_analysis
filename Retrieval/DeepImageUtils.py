...
from keras.layers import  GlobalAveragePooling2D, Lambda, GlobalMaxPool2D
...
# inception_category = InceptionResNetV2(include_top=True, weights=None)
...
# inception_conv = InceptionResNetV2(include_top=False, weights=None)
...
# global_pooling = GlobalMaxPool2D()(inception_conv.output)
